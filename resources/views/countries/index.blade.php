...
<body class="bg-gray-100">
    <div class="container mx-auto px-4 py-8">
        ...
        <form action="{{ route('countries.index') }}" method="GET" class="mb-6">
            <input type="text" name="search" placeholder="Search countries" class="p-2 border rounded" value="{{ request('search') }}">
            ...
            <select name="official_lang_code" class="p-2 border rounded">
                ...
                @foreach($languages as $language)
                    <option value="{{ $language }}" {{ request('official_lang_code') == $language ? 'selected' : '' }}>{{ $language }}</option>
                @endforeach
            </select> --}}
        ...
        <table class="w-full bg-white shadow-md rounded">
            <thead>
                <tr class="bg-gray-200 text-gray-600 uppercase text-sm leading-normal">
                    ...
                    <th class="py-3 px-6 text-left">Official Language</th>
            ...
            <tbody class="text-gray-600 text-sm font-light">
                ...
                <tr class="border-b border-gray-200 hover:bg-gray-100">
                    ...
                    <td class="py-3 px-6 text-left">{{ $country->official_lang_code }}</td>
